...
```
```
docker run --rm -it -p 8080:8080 -v /path/to/workdir:/application -e COMMAND="wine explorer /desktop=application,\${DISPLAY_WIDTH}x\${DISPLAY_HEIGHT} regedit" taitov/wine-novnc
```
